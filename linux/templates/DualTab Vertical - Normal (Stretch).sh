...
LAYER_POSTER_MAIN=( \( "$inputfile" -scale 372x482\! -brightness-contrast 5x15 -modulate 100,110 -gravity Northwest -geometry +51+4 "$DualTabV_front" \) -compose over -composite \( "$DualTabV_frontfx" -scale 512x512\! \) -compose over -composite )
