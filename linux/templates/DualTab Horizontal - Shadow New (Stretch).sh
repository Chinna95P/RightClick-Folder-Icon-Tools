...
LAYER_POSTER_MAIN=( \( "$inputfile" -scale 488x305\! -brightness-contrast 5x15 -modulate 100,110 -gravity Northwest -geometry +12+155 "$DualTabH_front" \) -compose over -composite \( "$DualTabH_frontfx" -scale 512x512\! \) -compose over -composite )
